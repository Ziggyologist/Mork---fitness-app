...
// const cycling1 = new Cycling([39, -12], 16, 29, 5238);
...
class App {
  ...
  _hideForm() {
    ...
    setTimeout(() => (form.style.display = "flex"), 1);
  }
  ...
  _newWorkout(e) {
    ...
    if (type === "running") {
      ...
      if (
        ...
        return alert("Inputs have to be larger than 0");

      workout = new Running([lat, lng], distance, duration, cadence);
      // Push the new object to the workout array
